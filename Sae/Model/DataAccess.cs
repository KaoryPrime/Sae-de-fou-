...
namespace Sae.Model
{
    public class DataAccess
    {
        ...
        private readonly string connectionString = "Host=srv-peda-new;Port=5433;Username=sailletn;Password=Kn06jg;Database=Loxam_bd;Options='-c search_path=Loxam_schema'";
